...
NX          = 100;                          % Number of horizontal Elements
...
amountOfParticles = [0,0,0,0,0,1]; %Amount of particle 1, particle 2, ... (sum should be 1)

attraction_type = 2; % 1: old volume charges, 2: no charges, 3: edge Charges
...
%     fileName    = ['initialConfig','.', num2str(numRun),'.mat'];
    load(['InitialConfig/initialConfig','.', num2str(numRun),'.mat'],'bulkVector','bulkTypeVector','chargeInfo','particle1List','particle2List',...
        'particle3List','particle4List','particle5List','particle6List','concAgent','edgeChargeVector','particleTypeVector');

else
    [bulkVector,bulkTypeVector,chargeInfo,particle1List, particle2List, particle3List, particle4List, particle5List, particle6List, concAgent, edgeChargeVector, particleTypeVector] = ...
...
%         visualizeDataSub(g, uLagr, 'u', 'solu', 0);
        ...
        uDG         = UDG;
        printInfo(0,bulkVector,particle1List,particle2List,particle3List,particle4List,particle5List, particle6List);
    else
        UDG    = zeros(g.numTsub, N);
        UDG(airVectorSub,:) = reshape( sysX( 2 * NT * N + 1 : 3 * NT * N ), N, NT )';
%         UDG(bulkTypeVector == QuartzCharge,1) = -1;
...
printInfo(k,bulkVector,particle1List,particle2List,particle3List,particle4List,particle5List, particle6List)
...
%     particleDistribution
    ...
    if(mod(k,1000) == 0 || k == numOuterIt)
        ...
        save(fileName,'bulkVector','bulkTypeVector','chargeInfo','particle1List','particle2List','particle3List','particle4List','particle5List',...
            'particle6List','concAgent','edgeChargeVector')        
    end
