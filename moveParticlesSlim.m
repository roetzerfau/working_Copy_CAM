function [ bulkVector, bulkTypeVector, particleTypeVector, reactiveSurfaceVector, particleList ,flag] = ...
    moveParticlesSlim( bulkSize , stencilLayers , g , bulkVector, bulkTypeVector, particleTypeVector,...
    reactiveSurfaceVector, NZd , fileID, particleList ,typeflag,stencil_type, attraction_type, particle_index)
                ...
                for k = 1 : size( candidates , 2 ) %iteriere über Blöcke des Kandidaten
                   ...
                   for l = 1 : 4
                       ...
                       switch attraction_type
                           case 1 % without charges
                                aim( j ) = aim( j ) + (( bulkVector( neighbours( 1 , m ) ) ) ...
                                              * ( ~any( candidates( i , : ) == neighbours( 1 , m ) )));  
                           case 2  % attraction over reactive edges
